...
<html lang="en">
  ...
  <body>
    ...
    <!-- END nav -->
      ...
      <div class="slider-item" style="background-image: url(images/chef0.jpg);">
     ...
     <div class="slider-item" style="background-image: url(images/chef4.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              ...
              <p class="mb-4 mb-md-5"><font size="20px">"Techniques are not the most difficult to teach. The attitudes CHEFS take are much more important."</font></p>
    ...
    <div class="slider-item" style="background-image: url(images/chef1.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              <span class="subheading">Welcome to</span>
              <h1 class="mb-4">THE FOODEEZ</h1>
              <p class="mb-4 mb-md-5"><font size="20px">"If you want to become a great chef, you have to work with great chefs."</font></p>
          ...
          <div class="slider-item" style="background-image: url(images/chef3.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              <span class="subheading">Welcome to</span>
              <h1 class="mb-4">THE FOODEEZ</h1>
              <p class="mb-4 mb-md-5"><font size="20px">"COOKING is the ultimate giving."</font></p>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">World Best Chef's</h2>
    	...
    	<div class="container-fluid">
           ...
           <?php
        $row = $obj->getMasterData('chef');
        foreach($row as $key=>$val)
        {
        ?>
    			<div class="col-lg-10 d-flex ftco-animate mb-5">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img" style="background-image: url(<?php echo $val['img'] ?>); height: 500px; border-radius: 50%; border: solid 3px white"></a>
    					<div class="text p-4">
                <br><br>
