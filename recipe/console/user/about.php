...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel img" style="background-image: url(images/bg_1.jpg);">
      ...
      <div class="slider-item" style="background-image: url(images/aboutus1.jpg);">
          ...
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              ...
              <h1 class="mb-0">THE FOODEEZ</h1>
            	<h1 class="mb-3 mt-5 bread"><font size="30px">About US</font></h1>
	            <p class="breadcrumbs"><span class="mr-2"><a href="index.php"><h3>Home</h3></a></span> </p>
            </div>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4">Welcome to The FOODEEZ </h2>
  				...
  				<p>The Foodeez is a recipe website. We partner with the top local shops in city and provide expert delivery services to meet daily orders. We work with our customers to make them regularly use the website and enjoy cooking. Our website is customizable and scalable, offering customers to view famous chef's recoipes, upcoming cooking events, news and to calculate calories. Also alllowing them to upload and download new recipes. </p>
        <div>
  			</div>
    	</div>
    </section>
    	...
    	<div class="container-wrap">
    		<div class="row no-gutters">
					<div class="col-md-3 ftco-animate">
						<a href="gallery.html" class="gallery img d-flex align-items-center" style="background-image: url(images/gal6.jpg);">
					...
					<div class="col-md-3 ftco-animate">
						<a href="gallery.html" class="gallery img d-flex align-items-center" style="background-image: url(images/gal1.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-search"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="gallery.html" class="gallery img d-flex align-items-center" style="background-image: url(images/gal4.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-search"></span>
    					</div>
						</a>
					...
					<div class="col-md-3 ftco-animate">
						<a href="gallery.html" class="gallery img d-flex align-items-center" style="background-image: url(images/gal2.jpg);">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-search"></span>
    					</div>
						</a>
