...
<html lang="en">
  ...
  <body>
    ...
    <!-- END nav -->
      ...
      <div class="slider-item" style="background-image: url(images/pl31.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">

            <div class="col-md-7 col-sm-8 ftco-animate">
              <span class="subheading">Welcome to</span>
              <h1 class="mb-0">THE FOODEEZ</h1><br>
              <p class="mb-0 mb-md-1"><font size="20px">"RECIPE is a KING but PLATING is a QUEEN & a King never wins without a Queen. "</font></p>
     ...
     <div class="slider-item" style="background-image: url(images/pl26.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              ...
              <p class="mb-4 mb-md-5"><font size="20px">“Smile once a while; even if recipe tastes like bitter bile, you are just PLATING away."</font></p>
    ...
    <div class="slider-item" style="background-image: url(images/pl30.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              <span class="subheading">Welcome to</span>
              <h1 class="mb-4">THE FOODEEZ</h1>
              <p class="mb-4 mb-md-5"><font size="20px">“Cooking is itself a gallant, PLATING is mere decoration.”</font></p>
          ...
          <div class="slider-item" style="background-image: url(images/pl18.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              <span class="subheading">Welcome to</span>
              <h1 class="mb-4">THE FOODEEZ</h1>
              <p class="mb-4 mb-md-5"><font size="20px">"A simple TOPING is a HEART of PLATING."</font></p>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Different Serving Suggestion</h2>
    	...
    	<div class="container-fluid">
           ...
           <?php
        $row = $obj->getMasterData('plate');
        foreach($row as $key=>$val)
        {
        ?>
    			<div class="col-lg-6 d-flex ftco-animate mb-5">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img" style="background-image: url(<?php echo $val['img'] ?>); height: 500px; border-radius: 10%; border: solid 3px white"></a>
    					<div class="text p-4">
                <br><br>
