...
<html lang="en">
  ...
  <body>
    ...
    <!-- END nav -->
      ...
      <div class="slider-item" style="background-image: url(images/rec13.jpg);">
     ...
     <div class="slider-item" style="background-image: url(images/rec15.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text  align-items-center" data-scrollax-parent="true">

            <div class="col-md-4 col-sm-6 text-center ftco-animate">
              <span class="subheading">Welcome to</span>
              <h1 class="mb-0">THE FOODEEZ</h1>
              <p class="mb-0 mb-md-1"><font size="20px">"Everything you see, I owe to COOKING."</font></p>
    ...
    <div class="slider-item" style="background-image: url(images/rec9.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              ...
              <p class="mb-4 mb-md-5"><font size="20px" color="black">"FOOD is not just eating energy, it's an EXPERIENCE."</font></p>
          ...
          <div class="slider-item" style="background-image: url(images/rec16.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
              <span class="subheading">Welcome to</span>
              <h1 class="mb-4">THE FOODEEZ</h1>
              <p class="mb-4 mb-md-5"><font size="20px">"A balanced diet is a piece of CAKE in each hand."</font></p> 
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Best Recipe Books</h2>
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-md-5">
             <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">Serving Suggestion</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
