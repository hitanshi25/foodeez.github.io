	...
	class GalleryController extends Controller
	{
        ...
        public function loadview($action)
		{
			...
			if($action == 'listdata')
			{
                ...
                include 'page/gallery/list.php';
            }
            
            if($action == "addform")
            {
                include 'page/gallery/form.php';
            }
            ...
            if($action == "add")
            {
                ...
                $this->redirect("index.php?ontroller=gallerycontroller&action=listdata");  
            ...
            if($action == "edit")
            {
               ...
               $this->redirect("index.php?controller=gallerycontroller&action=listdata");
            }
