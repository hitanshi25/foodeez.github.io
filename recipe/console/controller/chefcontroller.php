	...
	class ChefController extends Controller
	{
        ...
        public function loadview($action)
		{
			...
			if($action == 'listdata')
			{
                ...
                include 'page/chef/list.php';
            }
            
            if($action == "addform")
            {
                include 'page/chef/form.php';
            }
            ...
            if($action == "add")
            {
               ...
               // $this->redirect("index.php?ontroller=chefcontroller&action=listdata");  
            ...
            if($action == "edit")
            {
              ...
              // $this->redirect("index.php?controller=chefcontroller&action=listdata");
            }
