...
<div class="card mb-3">
    ...
    <div class="col-lg-10">
        <div class="card-body">
             ...
             ?>
             <h1>ADD FORM</h1>
            <form method="post" action="index.php?controller=eventcontroller&action=add" enctype=multipart/form-data>
                <br>
                ...
                <div class="form-group">
                    <label><h2><font color="black">Venue:</font></h2></label>
                    <input type="text" name="venue" class="form-control" required>
                </div>
                

                <div class="form-group">
                    <label><h2><font color="black">Date:</font></h2></label>
        ...
        ?>
            ...
            {
            ?>
            <form method="post" action="index.php?controller=eventcontroller&action=edit" enctype=multipart/form-data>
                <div class="form-group">
                    <label><h2><font color="black">Name:</font></h2></label>
                ...
                <div class="form-group">
                    <label><h2><font color="black">Venue:</font></h2></label>
                    <input type="text" name="venue" class="form-control" required value="<?php echo $val['venue'] ?>">
                </div>
                

                <div class="form-group">
                    <label><h2><font color="black">Date:</font></h2></label>
                    <input type="date" name="edate" class="form-control" required value="<?php echo $val['edate'] ?>">
                </div>
