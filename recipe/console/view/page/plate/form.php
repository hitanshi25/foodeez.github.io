...
<div class="card mb-3">
    ...
    <div class="col-lg-10">
        <div class="card-body">
             ...
             ?>
             <h1>ADD FORM</h1>
            <form method="post" action="index.php?controller=platecontroller&action=add" enctype=multipart/form-data>
                <br>
        ...
        ?>
            ...
            {
            ?>
            <form method="post" action="index.php?controller=platecontroller&action=edit" enctype=multipart/form-data >
                <div class="form-group">
                    <label><h2><font color="black">Name:</font></h2></label>
