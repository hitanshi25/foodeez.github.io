...
<div class="card mb-3">
    ...
    <div class="col-lg-10">
        <div class="card-body">
             ...
             ?>
             <h1>ADD FORM</h1>
            <form method="post" action="index.php?controller=equipmentcontroller&action=add" enctype=multipart/form-data>
                <br>
        ...
        ?>
            ...
            {
            ?>
            <form method="post" action="index.php?controller=equipmentcontroller&action=edit" enctype=multipart/form-data >
